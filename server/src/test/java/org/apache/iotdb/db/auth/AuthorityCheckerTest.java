...
public class AuthorityCheckerTest {
  ...
  public void testAuthorityChecker() throws AuthException, IllegalPathException {
    ...
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.INSERT_TIMESERIES.ordinal());
    ...
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.READ_TIMESERIES.ordinal());
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.DELETE_TIMESERIES.ordinal());
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.REVOKE_USER_ROLE.ordinal());
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.GRANT_USER_ROLE.ordinal());
    ...
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.UPDATE_TIMESERIES.ordinal());
    authorizer.grantPrivilegeToUser(user.getName(), nodeName,
        PrivilegeType.GRANT_ROLE_PRIVILEGE.ordinal());
    authorizer.grantPrivilegeToUser(user.getName(), nodeName,
        PrivilegeType.GRANT_USER_PRIVILEGE.ordinal());
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.MODIFY_PASSWORD.ordinal());
    authorizer.grantPrivilegeToUser(user.getName(), nodeName,
    ...
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.SET_STORAGE_GROUP.ordinal());
    authorizer
        .grantPrivilegeToUser(user.getName(), nodeName, PrivilegeType.CREATE_TIMESERIES.ordinal());
    Assert.assertTrue(
