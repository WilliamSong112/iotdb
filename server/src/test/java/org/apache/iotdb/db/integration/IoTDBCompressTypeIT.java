...
public class IoTDBCompressTypeIT {
  ...
  public void testGZIPCompression() throws Exception {
    ...
    try (Connection connection = DriverManager
      ...
      statement
          .execute("insert into root.ln.wf01.wt01(timestamp,name,age) values(1000,'zhang',10)");
      ...
      for (int i = 1; i <= 1000; i++) {
        ...
        statement.execute(String
            .format("insert into root.ln.wf01.wt01(timestamp,name,age) values(%s,'wang', %s)", time,
                values));
      }

      statement.execute("flush");
      ResultSet r5 = statement
          .executeQuery("select * from root.ln.wf01.wt01 where timestamp = 100000");
      r5.next();
