    ...
    try (PrintWriter pw = new PrintWriter(new FileWriter(outFile))) {
      ...
      try (TsFileSequenceReader reader = new TsFileSequenceReader(filename)) {
        ...
        for (ChunkGroupMetadata chunkGroupMetadata : allChunkGroupMetadata) {
          ...
          printlnBoth(pw,
              String.format("%20s", nextChunkGroupHeaderPos) + "|\t[Chunk Group Header]");
          ChunkGroupHeader chunkGroupHeader = reader
              .readChunkGroupHeader(nextChunkGroupHeaderPos, false);
        ...
        Map<String, List<TimeseriesMetadata>> allTimeseriesMetadata = reader
        ...
        for (Map.Entry<Long, Pair<Path, TimeseriesMetadata>> entry : timeseriesMetadataMap
            .entrySet()) {
          printlnBoth(
